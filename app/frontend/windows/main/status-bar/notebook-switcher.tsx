...
import { Check, ChevronsUpDown, Folder, Pencil, Trash2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent
        ...
        side="top"
        sideOffset={6}
        className="flex flex-col max-h-[500px] overflow-hidden px-1 py-1.5 ml-2 bg-[var(--popover)]"
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto pb-1 space-y-1.5">
          {notebooks.length === 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pr-12">
                    <div className="flex items-center gap-1.5">
                      ...
                      {notebook.isDefault && (
                        <span className="shrink-0 rounded-lg px-1.5 py-[0px] text-[10px] bg-[var(--muted)] text-[var(--primary)]">
                          默认
                        </span>
                      )}
                    </div>
                  ...
                  {isActive && (
                    <Check className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--primary)] transition-opacity group-hover:opacity-0" />
                  )}
