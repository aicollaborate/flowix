...
import { listenToUserConfigChanges, stopListeningToUserConfigChanges, listenToAgentAccessChanges, stopListeningToAgentAccessChanges } from "./lib/tauri/client";
import { useAgentAccessStore } from "./lib/store/agent-access-store";
import { prewarmNotebookCache, invalidateNotebookCache } from "./components/mdeditor/extensions/note-reference";
import {
...
function App() {
  ...
  useEffect(() => {
    ...
    void listenToAgentAccessChanges(() => {
      void loadAgentAccess();
    ...
    return () => {
      stopListeningToAgentAccessChanges();
    };
  }, [loadAgentAccess]);
