...
import { AITextarea } from "../ui/textarea";
						...
						<DropdownMenuTrigger asChild>
							<div className="relative w-full">
								<AITextarea
									...
									disabled={isLoading}
									className="min-h-[40px] max-h-[160px] w-full overflow-auto resize-none border-0 p-0 bg-transparent placeholder:text-gray-600 placeholder:opacity-60 focus:outline-none focus:ring-0 text-sm"
					...
					<div className="flex justify-between mt-1">
						<Popover>
							<PopoverTrigger asChild>
								<button
									type="button"
									className="flex h-7 w-7 items-center justify-center rounded-full text-[var(--muted-foreground)] hover:bg-white/10"
									aria-label="Add"
								>
						...
						<Button
							...
							className="h-7 w-7 rounded-full bg-[var(--primary)] hover:bg-[var(--primary)] text-white disabled:opacity-50 disabled:cursor-not-allowed"
						>
