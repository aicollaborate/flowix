  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh] pointer-events-none">
        <div
          className={cn(
            'relative w-full max-w-[520px] mx-4 rounded-xl border border-[var(--border)] bg-[var(--popover)] text-[var(--popover-foreground)] shadow-2xl pointer-events-auto overflow-hidden',
