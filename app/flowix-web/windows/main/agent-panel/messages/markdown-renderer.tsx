...
// Agent 消息 Markdown 元素样式: 与中间 Tiptap 编辑器 (.comn-tiptap-editor .tiptap)
...
const WRAPPER_CLASS =
  ...
  // 内联 code: 视觉对齐 .comn-tiptap-editor .tiptap p code 的口径 —
            ...
            return (
              <div className={CODE_BLOCK_CLASS}>
                <SyntaxHighlighter
                  ...
                  customStyle={{
                    margin: 0,
                    // 与 tiptap pre 视觉对齐: 上下 0.5rem, 左右 0.75rem (tiptap 是 0.5/1/1),
                    // 右栏窄宽下横向 padding 收紧到 0.75rem 避免代码行被截。
                    padding: "0.5rem 0.75rem 0.75rem",
                    // 与 tiptap pre background: var(--code-block-bg) 同源
                    // (内联 code 用 --code-bg, 块用 --code-block-bg, 区分视觉权重 —
                    // 内联口径对齐 .tiptap p code, 见 WRAPPER_CLASS)。
