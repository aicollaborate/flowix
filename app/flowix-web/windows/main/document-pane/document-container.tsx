...
import { hasDocumentUnsavedChanges, useDocumentStore, useMemoStore } from '../../../lib/store';
...
export function DocumentContainer({
  ...
  useEffect(() => {
    ...
    const isDirtyForRename = !instanceKeyChanged && hasDocumentUnsavedChanges(filePath);
    if (isDirtyForRename) {
