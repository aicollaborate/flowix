        ...
        <div className="flex flex-wrap gap-1.5">
          {PRESETS.map((preset) => (
            <button
              ...
              className="inline-flex h-6 w-fit items-center rounded-full border border-[var(--border)] bg-[var(--muted)] px-2.5 text-xs text-[var(--foreground)] shadow-sm transition-colors hover:bg-[var(--muted)]/70"
            >
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="start"
        sideOffset={6}
        className="z-[1002] min-w-[120px] px-1 py-1.5"
      >
