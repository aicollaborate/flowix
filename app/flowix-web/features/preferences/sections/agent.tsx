  ...
  if (loadError) {
    return (
      <div className="space-y-3 pb-6">
        <SectionHeader title={t('preferences.agent.title')} />
      ...
      <div className="space-y-4">
        ...
        <Field title={t('preferences.agent.modelId.title')}>
          <Input
            ...
            placeholder={t('preferences.agent.modelId.placeholder')}
        ...
        {/* 4. 模型密钥(原"API 密钥") */}
        <Field title={t('preferences.agent.apiKey.title')} description={t('preferences.agent.apiKey.description')}>
          <Input
            type="password"
