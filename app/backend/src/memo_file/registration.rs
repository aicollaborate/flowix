...
impl MemoFile {
    ...
    pub(crate) fn sanitize_memo_filename_component(title: &str) -> String {
    ...
    pub(crate) fn generate_memo_filename(title: &str, memoid: &str) -> String {
    ...
    pub(crate) fn memo_title_from_filename(name: &str) -> Option<String> {
